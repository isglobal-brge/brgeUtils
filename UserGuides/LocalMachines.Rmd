...
Para que funcione esta combinación debe pulsarse *Ctrl + A* y *Ctrl + C* son combinaciones de botones, por lo que se deben pulsar a la vez. En este caso, primero pulsamos *Ctrl + A* y luego *Ctrl + C*. Esta combinación nos genera una nueva pestaña con el numero 1. Podemos ver las pestañas existentes con:
...
do
  mkdir $i
  mv $i.mrm.sig_results.txt ./$i
  mv ../plots/"$i"_mrmosaic_plot.pdf /home/isglobal.lan/dfernandez/data/PROJECTS/URDcat/all_mrmosaic_results/
done
```
