...
nofilter_michigan_invclust_7 <- computeInvClust(range = GRanges(c(r="7:54290974-54386821")), vcffile = "/scratch/itolosana/impute/new_michigan_imputation/nofilter_invreg_michigan_chr7.vcf.gz")
...
nofilter_minimac_inv_8 <- scoreInvHap(SNPlist = nofilter_minimac_8, SNPsR2 = R2s, hetRefs = hRefs, Refs = ref, imputed = TRUE, verbose = TRUE, BPPARAM = MulticoreParam(10))
#nofilter_michigan_inv_8 <- scoreInvHap(SNPlist = nofilter_michigan_8, SNPsR2 = R2s, hetRefs = hRefs, Refs = ref, imputed = TRUE, verbose = TRUE, BPPARAM = MulticoreParam(10))
nofilter_minimac_invclust_8 <- computeInvClust(range = GRanges(c(r="8:8055789-11980649")), vcffile = "/scratch/itolosana/impute/new_minimac_imputation/nofilter_invreg_minimac_chr8.vcf.gz")
#nofilter_michigan_invclust_8 <- computeInvClust(range = GRanges(c(r="8:8055789-11980649")), vcffile = "/scratch/itolosana/impute/new_michigan_imputation/nofilter_invreg_michigan_chr8.vcf.gz")
...
nofilter_minimac_inv_17 <- scoreInvHap(SNPlist = nofilter_minimac_17, SNPsR2 = R2s, hetRefs = hRefs, Refs = ref, imputed = TRUE, verbose = TRUE, BPPARAM = MulticoreParam(10))
#nofilter_michigan_inv_17 <- scoreInvHap(SNPlist = nofilter_michigan_17, SNPsR2 = R2s, hetRefs = hRefs, Refs = ref, imputed = TRUE, verbose = TRUE, BPPARAM = MulticoreParam(10))
nofilter_minimac_invclust_17 <- computeInvClust(range = GRanges(c(r="17:43661775-44372665")), vcffile = "/scratch/itolosana/impute/new_minimac_imputation/nofilter_invreg_minimac_chr17.vcf.gz")
#nofilter_michigan_invclust_8 <- computeInvClust(range = GRanges(c(r="17:43661775-44372665")), vcffile = "/scratch/itolosana/impute/new_michigan_imputation/nofilter_invreg_michigan_chr8.vcf.gz")
```
